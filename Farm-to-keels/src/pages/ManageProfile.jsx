...
const ManageProfile = () => {
  ...
  useEffect(() => {
    if (farmer) {
      ...
      setPreviewImage(farmer.avatar_url ? `${farmer.avatar_url}?${Date.now()}` : '');
    }
  }, [farmer]);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-cover bg-center p-4 pt-24" 
         style={{ backgroundImage: "url('src/assets/background.jpg')" }}>
      <div className="bg-white bg-opacity-70 backdrop-blur-lg p-6 rounded-2xl shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold text-center mb-6">Change Profile Details</h2>
